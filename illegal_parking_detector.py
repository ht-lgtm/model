...
# --- Configuration ---
VIDEO_PATH = "C:/Users/SBA\Downloads/Screen_Recording_20250806_141749_Samsung Internet.mp4"
MODEL_PATH = "C:/Users/SBA/github/yolov11/yolo11n.pt"
...
while cap.isOpened():
    ...
    results = model.track(frame, persist=True, classes=[1, 2, 3, 5, 6, 7], verbose=False, tracker="bytetrack.yaml")
